                                    ...
                                    <div class="col-md-12">
                                        <div id="history-visits">
                                            ...
                                            <div class="card-body p-0 m-1">
                                                <h6 class="card-title m-1"><p class="d-inline"><b class="ml-1">{{ tempVisit.date[0] }}.{{ tempVisit.date[1] }}.{{ tempVisit.date[2] }}</b>, godz. {{ tempVisit.hour }}</p> <p class="float-right d-inline">koszt wizyty <cite title="Source Title">{{ tempVisit.cost }}zł</cite>, Zapłacono <cite title="Source Title">{{ tempVisit.cost }}zł.</cite></p>
                                                <button class="btn btn-sm btn-danger btn-blockm-0 m-0 p-0 d-inline float-right" v-if="tempVisit.state == 1 && genVars[2] < tempVisit.date[2]" v-on:click="delFunc(tempVisit._id)" style="width:70px;height:18px;font-size:11px">Odwołaj</button>
                                                </h6>
